...
//simulates the path of a laser beam through the grid
...
//describes what the world likely looks like given a measurement
...
void MappingWithKnownPoses::scanCallback(const sensor_msgs::msg::LaserScan &scan)
{
    ...
    for (size_t i = 0; i < scan.ranges.size(); i++)
    {
      ...
      //5. Convert Beam Hit to Map Coordinates
