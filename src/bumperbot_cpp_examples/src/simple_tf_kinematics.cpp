      ...
      rotations_counter_(0)
{
  ...
  //inilized the buffer an the listenr 
  ...
  // Timer to update the position and orinetion of the bumperbot base relative to the odom
  ...
  orientation_increment_.setRPY(0, 0, 0.05); // in radians rotate around the z-axis
}
...
{  
  ...
  last_orientation_ = q;
  rotations_counter_++;
  // Reverse rotation after 100 rotations
                                              ...
                                              const std::shared_ptr<bumperbot_msgs::srv::GetTransform::Response> res)
{
  ...
  try{
    //lookup the tranform in the buffer
