...
public:
  SimpleQosPublisher() : Node("simple_qos_publisher"), qos_profile_pub_(10), counter_(0)
  {
    ...
    //check the reliability and ensure it is set 
    ...
    //you can set other QoS but we will keep it at two at this point

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    pub_ = create_publisher<std_msgs::msg::String>("chatter", qos_profile_pub_); // use the qos_profile_pub to set the QoS
...
private:
  ...
  rclcpp::QoS qos_profile_pub_; // to ensure compatiblity with subscriber
